    ...
    return (
        <Container>
            <Paper elevation={3} style={{ padding: '50px 20px', width: 600, margin: '20px auto' }}>
                <h2 style={{ color: '#1E7FCB', textAlign: 'center', fontSize: 28 }}>Fatigua</h2>
                <h1 style={{ color: 'grey', textAlign: 'center' }}>Avec Fatigua, déplacez-vous et restez en contact avec votre entourage.</h1>
